...
class SimpleHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def list_directory(self, path):
        ...
        f.write("<input type=\"button\" value=\"HomePage\" onClick=\"location='/'\"></form>\n")
        f.write("<hr>\n<ul>\n")
        
        f.write('<table id="file-table" cellpadding="0" cellspacing="0">\n')
        f.write('<colgroup> <col width="60%"> <col width="20%"> <col width="20%"> </colgroup>\n')
        for name in list:
