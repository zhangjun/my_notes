...
int main() {
	...
	for(int i = 0; i < 1000; i ++){
		...
		std::cout << "cost: [" << std::chrono::duration_cast<std::chrono::microseconds>(mid - begin).count() << "," 
				       << std::chrono::duration_cast<std::chrono::microseconds>(end - mid).count() << "]" << std::endl; 
	}
	...
	std::cout << "t: " << std::chrono::duration_cast<std::chrono::microseconds>(e - b).count() << std::endl; 
