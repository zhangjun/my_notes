...
int main(int argc, char *argv[]) {
  ...
  LogHead logd;
  logd.size = sizeof(
      "{\"log_type\":\"mobile_query\",\"status\":1000,\"date\":\"2015-02-11 "
      "13:00:01\",\"uid\":\"123456789\",\"search\":\"youhu\",\"time\":0."
      "20535993576}");
  ...
  while (num--) {
    ...
    if (sendto(sock, snd_buff, sizeof(snd_buff), 0, (struct sockaddr *)&toAddr,
               sizeof(toAddr)) < 0) {
