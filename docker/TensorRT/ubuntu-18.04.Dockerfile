...
RUN pip3 install jupyter jupyterlab  -i https://pypi.douban.com/simple
# Workaround to remove numpy installed with tensorflow
RUN pip3 install --upgrade numpy  -i https://pypi.douban.com/simple

# Install Cmake
COPY cmake-3.22.3-Linux-x86_64.sh /tmp/cmake-3.22.3-Linux-x86_64.sh
...
RUN cd /tmp && \
    ...
    ./cmake-3.22.3-Linux-x86_64.sh --prefix=/usr/local --exclude-subdir --skip-license && \
